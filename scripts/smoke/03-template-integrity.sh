...
assert_file "${ROOT_DIR}/templates/backend/.cursor/commands/check-scaffold.md"
...
assert_file "${ROOT_DIR}/templates/frontend/.cursor/commands/check-scaffold.md"
...
assert_contains "${ROOT_DIR}/templates/backend/.cursor/commands/tune-project.md" "本次 diff Top N 条真实变更"
assert_contains "${ROOT_DIR}/templates/frontend/.cursor/commands/tune-project.md" "本次 diff Top N 条真实变更"
assert_contains "${ROOT_DIR}/templates/backend/.cursor/commands/tune-project.md" "变化证据段（3~5 个关键文件）"
assert_contains "${ROOT_DIR}/templates/frontend/.cursor/commands/tune-project.md" "变化证据段（3~5 个关键文件）"
assert_contains "${ROOT_DIR}/templates/backend/.cursor/commands/tune-project.md" "无效证据反例（禁止）"
assert_contains "${ROOT_DIR}/templates/frontend/.cursor/commands/tune-project.md" "无效证据反例（禁止）"
assert_contains "${ROOT_DIR}/templates/backend/.cursor/commands/tune-project.md" "有效证据最小示例（参考）"
assert_contains "${ROOT_DIR}/templates/frontend/.cursor/commands/tune-project.md" "有效证据最小示例（参考）"
assert_contains "${ROOT_DIR}/templates/backend/.cursor/commands/tune-project.md" "<具体文件路径>"
assert_contains "${ROOT_DIR}/templates/frontend/.cursor/commands/tune-project.md" "<具体文件路径>"
...
assert_contains "${ROOT_DIR}/templates/backend/.cursor/commands/check-scaffold.md" "若无则建议新建（如"
assert_contains "${ROOT_DIR}/templates/frontend/.cursor/commands/check-scaffold.md" "若无则建议新建（如"
